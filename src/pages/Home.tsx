          ...
          <div className="max-w-5xl mx-auto rounded-3xl p-12 md:p-16 bg-muted border border-border">
            <div className="flex flex-col md:flex-row items-center gap-10">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-white/70 mb-6">It's the perfect time to get started!</p>
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 font-bold text-sm px-8 py-3 rounded-full transition-base hover:opacity-90"
                  style={{ backgroundColor: '#FF6B4A', color: '#1A1A2E' }}
                >
                  CONTACT ME
                </Link>
              </div>
              ...
              <div className="flex flex-col gap-4 min-w-[260px]">
                <a
                  ...
                  className="flex items-center gap-4 p-4 rounded-xl border border-white/10 hover:border-white/30 transition-base"
                >
                  ...
                  <div>
                    ...
                    <div className="text-white/60 text-xs">adebukolaakanji@gmail.com</div>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-white/60 text-xs">+234 706 519 7102</div>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-white/60 text-xs">Connect with me</div>
                  </div>
                </a>
              </div>
            </div>
