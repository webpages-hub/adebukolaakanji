...
const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    description: "Built a seamless multi-currency wallet system that increased daily active usage by PRODUCT STRATEGY", "USER EXPERIENCE", "GROWTHliance", "UX Design"],
